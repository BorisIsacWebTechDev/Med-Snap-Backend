    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_type', models.CharField(choices=[('Click to select', 'Click to select'), ('DR', 'Doctor'), ('RECEPTION', 'Reception')], default='Click to select', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speciality_type', models.CharField(choices=[('Click to select', 'Click to select'), ('DERMOTOLOGY', 'DERMOTOLOGY'), ('PLASTIC SURGERY', 'PLASTIC SURGERY'), ('Aesthetic Medicine Dermatologist', 'Aesthetic Medicine Dermatologist'), ('SPECIALITY4', 'SPECIALITY4'), ('SPECIALITY5', 'SPECIALITY5'), ('SPECIALITY6', 'SPECIALITY6')], default='Click to select', max_length=50)),
            ],
            options={
                'verbose_name': 'DR',
